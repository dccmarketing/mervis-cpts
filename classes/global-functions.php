 ...
 */
function MERVIS_CPTS_get_svg( $svg ) {
 ...
 */
function MERVIS_CPTS_get_template( $name, $location = '' ) {
	 ...
	 */
	$locations 	= apply_filters( 'MERVIS_CPTS_template_paths', $locations );
